...
public class Network extends Thread {
     ...
     * @param
     */
    // I changed the run method -Axel
    // The loop continues as long as neither the server nor the client is disconnected.
    // This is a straightforward way to keep the network thread alive during the communication session.
    // The network thread terminates when either the client or the server (or both) disconnects,
    // which is a logical endpoint for network operations in a client-server model.
    @Override
    public void run()
    {	
